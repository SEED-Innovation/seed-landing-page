  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col items-center justify-center bg-white p-1.5 md:p-4 w-24 md:w-32 h-24 md:h-32 gap-1 md:gap-2 rounded-xl md:rounded-3xl /95 backdrop-blur-md border border-white/50 shadow-lg md:shadow-xl cursor-pointer"
      >
